...
| ------------------------------------ | ---------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Artificial](Artificial/README.md)   | Easy       | CVE-2024-3660, Docker, Reverse Shell, Hashcat, SSH port forwarding, Backrest,<br>PrivEsc                                                                                                             |
| [TombWatcher](TombWatcher/README.md) | Medium     | BloodHound, Kerberoast, Weak password, hashcat, ACE abuse, GMSA,<br>Password change abuse, Tombstone restore, evil-winrm, certipy-ad, <br>nxc (NetExec), BloodyAD, ADCS ESC15 PrivEsc → Domain Admin |
