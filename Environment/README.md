...
I then noticed that `www-data` can access Hish's home directory, due to weak permissions on the home directory.  I notice some GPG private keys and a `~/backup/keyvault.gpg` file.
